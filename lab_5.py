...
We first red in the text file textese.txt.
...
We then define a function for translating which involves splitting the user input into an 
...
loop through each words, find the key marching the word and returns back the value tied to that
